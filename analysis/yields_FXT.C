...
void yields_FXT(){
    ...
    std::ifstream f70cm("yields_FXT_11p5GeV.txt");
    std::ifstream f100cm("yields_FXT_13p7GeV.txt");
    std::ifstream f19p6("yields_FXT_19p6GeV.txt");
    std::ifstream f27("yields_FXT_27GeV.txt");
    std::ifstream f39("yields_FXT_39GeV.txt");
	...
	kratplot11p5->SetTitle("Fixed Target");
